...
public:
	SdlSetupNetgameDialog ()
	{
		...
		w_env_select* map_w = new w_env_select ("", "利用可能なマップ", _typecode_scenario, &m_dialog);
		...
		w_env_select* choose_script_w = new w_env_select ("", "利用可能なネットスクリプト", _typecode_netscript, &m_dialog);
